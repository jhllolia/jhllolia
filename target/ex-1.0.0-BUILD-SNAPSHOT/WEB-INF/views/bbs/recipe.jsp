				...
				<c:forEach items="${list}" var="dto">
					<div class="recipe">
						<c:choose>
							...
							<a class="recipe_txt">
								<strong class="recipe_txt_1"><c:out value='${dto.recipe_Subject.replaceAll("\\\<.*?\\\>","")}' /></strong>
								<c:choose>
									<c:when test="${dto.recipe_Category == '후기'}">
										<p class="recipe_txt_2"><c:out value='${dto.recipe_SubTitle.replaceAll("\\\<.*?\\\>","")}' /></p>
									</c:when>
									<c:otherwise>
										<p class="recipe_txt_2"><c:out value='${dto.recipe_Content.replaceAll("\\\<.*?\\\>","")}' /></p>
									</c:otherwise>
								</c:choose>
							</a>
							<div class="recipe_txt_3">
